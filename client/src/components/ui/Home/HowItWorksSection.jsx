...
function HowItWorksSection() {
  const StepsToOrderPizza = [
    {
      ...
      description: 'Browse our delicious range of pizzas and select your favorite one.',
    },
    {
      step: 2,
      icon: <FaCartPlus />,
      title: 'Add to Cart',
      description: 'Click the "Add to Cart" button to add your chosen pizza to your cart.',
    },
    {
      step: 3,
      icon: <FaMoneyCheckAlt />,
      title: 'Checkout Your Order',
      description: 'Review your order details and proceed to the secure checkout.',
    },
    {
      step: 4,
      icon: <BsFillEmojiHeartEyesFill />,
      title: 'Enjoy Your Pizza',
      description: 'Sit back, relax, and enjoy your delicious pizza delivered to your doorstep.',
    },
  ];
  ...
  return (
    <section
      id="how-it-works"
      className="flex flex-col justify-center items-center py-16 sm:py-20 px-10 sm:px-16 bg-gradient-to-b from-primary-100 to-neutral-50"
    >
      <h1 className="font-display text-h1 text-primary-600 mb-2 text-center">How It Works</h1>
