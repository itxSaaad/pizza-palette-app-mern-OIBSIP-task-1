...
function PrivacyScreen() {
  return (
    <section className="min-h-screen flex flex-col items-center pt-24 pb-16 px-6 sm:px-16 bg-neutral-50">
      <h1 className="font-display text-h1 text-primary-600 mb-2 text-center">Privacy Policy</h1>
      <p className="text-neutral-600 mb-8 text-center max-w-xl">
        This is a plain-language explanation of what we collect and why — not a substitute for
        formal legal advice.
      </p>
